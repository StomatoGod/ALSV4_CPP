...
#include "AAADPlayerState.generated.h"

UCLASS()
class ALSV4_CPP_API AAAADPlayerState : public APlayerState
{
	...
	void ScoreKill(AAAADPlayerState* Victim, int32 Points);

	/** player died */
	void ScoreDeath(AAAADPlayerState* KilledBy, int32 Points);
	...
	UFUNCTION(Reliable, Client)
		void InformAboutKill(class AAAADPlayerState* KillerPlayerState, const UDamageType* KillerDamageType, class AAAADPlayerState* KilledPlayerState);

	/** broadcast death to local clients */
	UFUNCTION(Reliable, NetMulticast)
		void BroadcastDeath(class AAAADPlayerState* KillerPlayerState, const UDamageType* KillerDamageType, class AAAADPlayerState* KilledPlayerState);
